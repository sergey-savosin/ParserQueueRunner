...
<div class="oblock">
	...
	<div class="dheader">
        ...
        <div class="dcell">Команда</div>
        <div class="dcell">Параметры</div>
        <div class="dcell">Статус</div>
        <div class="dcell">Ошибка</div>
        <div class="dcell">Создана</div>
        <div class="dcell">Модифицирована</div>
	</div>
	<?php
